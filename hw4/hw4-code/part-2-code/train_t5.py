...
def get_args():
    ...
    parser.add_argument('--model_name', type=str, default='google-t5/t5-small', help="Model name to use")
    parser.add_argument('--max_len', type=int, default=256, help="Max length for generation")
    ...
    parser.add_argument('--scheduler_type', type=str, default="cosine", choices=["none", "cosine", "linear"], help="Whether to use a LR scheduler")
    parser.add_argument('--num_warmup_epochs', type=int, default=0, help="How many epochs to warm up")
    parser.add_argument('--max_n_epochs', type=int, default=100, help="How many epochs to train the model for")
...
def train(args, model, tokenizer, train_loader, dev_loader, optimizer, scheduler):
    ...
    # Use the cached ground truth records
...
def eval_epoch(args, model, tokenizer, dev_loader, gt_sql_pth, model_sql_path, gt_record_path, model_record_path):
    ...
    generation_config = GenerationConfig(
        max_new_tokens=args.max_len, # Use argument for max len
...
def test_inference(args, model, tokenizer, test_loader, model_sql_path, model_record_path):
    ...
    generation_config = GenerationConfig(
        max_new_tokens=args.max_len, # Use argument
        pad_token_id=PAD_IDX,
        eos_token_id=tokenizer.eos_token_id,
        num_beams=4
    )
...
def main():
    ...
    # Pass args to use correct model name
    ...
    # Use args to load correct experiment folder
    ...
    # Use experiment name for output file
